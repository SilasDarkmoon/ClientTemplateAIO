...
using static UnityEditorEx.EditorWindowExtensions;
    ...
    public class DynamicPrefabInspector : InspectorBase<DynamicPrefab>
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (oldSource != spSource.stringValue)
            {
                ...
                oldPrefab = null;
                var path = ResManager.EditorResLoader.CheckDistributePath("ModRes/" + oldSource, true);
                if (path != null)
                {
            ...
            if (newObj != oldObj)
            {
                ...
                if (newObj != null)
                {
                    ...
                    newNorm = ResInfoEditor.GetAssetNormPath(newPath);
                }
                newNorm = newNorm ?? "";
