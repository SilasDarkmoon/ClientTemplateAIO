// ModLuaNative.cpp : 定义 DLL 应用程序的导出函数。
//
...
extern "C"
{
    ...
    EXPORT_API int lua_checkVer(int ver)
    {
        #if !TARGET_OS_IPHONE
    ...
    EXPORT_API void lua_setCSFuncs(
    ...
    EXPORT_API void lua_wrapFunctionByTable(lua_State *l, void* methodmeta)
    {
        // rawfunc
        lua_checkstack(l, 5);
    ...
    EXPORT_API void lua_pushTypeIndex(lua_State *l, int n_upvalue)
    {
    ...
    EXPORT_API void lua_pushTypeNewIndex(lua_State *l, int n_upvalue)
    {
    ...
    EXPORT_API void lua_pushObjIndex(lua_State *l, int n_upvalue)
    {
    ...
    EXPORT_API void lua_pushObjNewIndex(lua_State *l, int n_upvalue)
    {
    ...
    EXPORT_API void lua_pushCommonBinaryOp(lua_State *l, int n_upvalue)
    {
    ...
    EXPORT_API void lua_pushCommonEq(lua_State *l, int n_upvalue)
    {
    ...
    EXPORT_API void lua_trackLiveness(lua_State* l, int index)
    {
    ...
    EXPORT_API int lua_checkLiveness(lua_State* l, int index)
    {
        lua_pushvalue(l, index); // tab
    ...
    // push-objs
    EXPORT_API void lua_pushObject(lua_State *l, void* obj, void* type, int shouldcache)
    {
        lua_checkstack(l, 6);
    ...
    EXPORT_API void lua_setObject(lua_State *l, int index, void* obj)
    {
        lua_checkstack(l, 6);
    ...
    EXPORT_API void lua_getObject(lua_State *l, int index, void** obj)
    {
        lua_checkstack(l, 2);
    ...
    EXPORT_API int lua_pushString(lua_State* l, int id)
    {
        lua_checkstack(l, 10);
    ...
    EXPORT_API void lua_pushAndRegString(lua_State* l, int id, const char* str)
    {
    ...
    EXPORT_API void lua_regString(lua_State* l, int id, const char* str)
    {
        lua_checkstack(l, 8);
        lua_pushlightuserdata(l, (void*)1001); // rkey
        lua_gettable(l, LUA_REGISTRYINDEX); // reg
    ...
    EXPORT_API void lua_unregString(lua_State* l, int id)
    {
        lua_checkstack(l, 8);
        lua_pushlightuserdata(l, (void*)1001); // rkey
        lua_gettable(l, LUA_REGISTRYINDEX); // reg
    ...
    EXPORT_API int lua_getStringRegId(lua_State* l, int index)
    {
    ...
    EXPORT_API void lua_setTypeVector3(void* type)
    {
        typeVector3 = type;
    }
    EXPORT_API void lua_pushVector3(lua_State *l, float x, float y, float z)
    {
        lua_checkstack(l, 3);
    ...
    EXPORT_API void lua_setVector3(lua_State *l, int index, float x, float y, float z)
    {
        lua_checkstack(l, 1);
    ...
    EXPORT_API void lua_getVector3(lua_State *l, int index, float* x, float* y, float* z)
    {
        lua_checkstack(l, 1);
    ...
    EXPORT_API void lua_setTypeLayerMask(void* type)
    {
        typeLayerMask = type;
    }
    EXPORT_API void lua_pushLayerMask(lua_State *l, int value)
    {
        lua_checkstack(l, 3);
    ...
    EXPORT_API void lua_setLayerMask(lua_State *l, int index, int value)
    {
        lua_checkstack(l, 1);
    ...
    EXPORT_API void lua_getLayerMask(lua_State *l, int index, int* value)
    {
        lua_checkstack(l, 1);
    ...
    EXPORT_API void lua_setTypeQuaternion(void* type)
    {
        typeQuaternion = type;
    }
    EXPORT_API void lua_pushQuaternion(lua_State *l, float x, float y, float z, float w)
    {
        lua_checkstack(l, 3);
    ...
    EXPORT_API void lua_setQuaternion(lua_State *l, int index, float x, float y, float z, float w)
    {
        lua_checkstack(l, 1);
    ...
    EXPORT_API void lua_getQuaternion(lua_State *l, int index, float* x, float* y, float* z, float* w)
    {
        lua_checkstack(l, 1);
    ...
    EXPORT_API void lua_setTypeColor(void* type)
    {
        typeColor = type;
    }
    EXPORT_API void lua_pushColor(lua_State *l, float r, float g, float b, float a)
    {
        lua_checkstack(l, 3);
    ...
    EXPORT_API void lua_setColor(lua_State *l, int index, float r, float g, float b, float a)
    {
        lua_checkstack(l, 1);
    ...
    EXPORT_API void lua_getColor(lua_State *l, int index, float* r, float* g, float* b, float* a)
    {
        lua_checkstack(l, 1);
    ...
    EXPORT_API void lua_setTypeRect(void* type)
    {
        typeRect = type;
    }
    EXPORT_API void lua_pushRect(lua_State *l, float xMin, float yMin, float width, float height)
    {
        lua_checkstack(l, 3);
    ...
    EXPORT_API void lua_setRect(lua_State *l, int index, float xMin, float yMin, float width, float height)
    {
        lua_checkstack(l, 1);
    ...
    EXPORT_API void lua_getRect(lua_State *l, int index, float* xMin, float* yMin, float* width, float* height)
    {
        lua_checkstack(l, 1);
    ...
    EXPORT_API void lua_setTypeVector2(void* type)
    {
        typeVector2 = type;
    }
    EXPORT_API void lua_pushVector2(lua_State *l, float x, float y)
    {
        lua_checkstack(l, 3);
    ...
    EXPORT_API void lua_setVector2(lua_State *l, int index, float x, float y)
    {
        lua_checkstack(l, 1);
    ...
    EXPORT_API void lua_getVector2(lua_State *l, int index, float* x, float* y)
    {
        lua_checkstack(l, 1);
    ...
    EXPORT_API void lua_setTypeVector4(void* type)
    {
        typeVector4 = type;
    }
    EXPORT_API void lua_pushVector4(lua_State *l, float x, float y, float z, float w)
    {
        lua_checkstack(l, 3);
    ...
    EXPORT_API void lua_setVector4(lua_State *l, int index, float x, float y, float z, float w)
    {
        lua_checkstack(l, 1);
    ...
    EXPORT_API void lua_getVector4(lua_State *l, int index, float* x, float* y, float* z, float* w)
    {
        lua_checkstack(l, 1);
    ...
    EXPORT_API void lua_setTypeBounds(void* type)
    {
        typeBounds = type;
    }
    EXPORT_API void lua_pushBounds(lua_State *l, float center_x, float center_y, float center_z, float extents_x, float extents_y, float extents_z)
    {
        lua_checkstack(l, 3);
    ...
    EXPORT_API void lua_setBounds(lua_State *l, int index, float center_x, float center_y, float center_z, float extents_x, float extents_y, float extents_z)
    {
        lua_checkstack(l, 1);
    ...
    EXPORT_API void lua_getBounds(lua_State *l, int index, float* center_x, float* center_y, float* center_z, float* extents_x, float* extents_y, float* extents_z)
    {
        lua_checkstack(l, 1);
    ...
    EXPORT_API void lua_setTypePlane(void* type)
    {
        typePlane = type;
    }
    EXPORT_API void lua_pushPlane(lua_State *l, float distance, float normal_x, float normal_y, float normal_z)
    {
        lua_checkstack(l, 3);
    ...
    EXPORT_API void lua_setPlane(lua_State *l, int index, float distance, float normal_x, float normal_y, float normal_z)
    {
        lua_checkstack(l, 1);
    ...
    EXPORT_API void lua_getPlane(lua_State *l, int index, float* distance, float* normal_x, float* normal_y, float* normal_z)
    {
        lua_checkstack(l, 1);
    ...
    EXPORT_API void lua_setTypeRay(void* type)
    {
        typeRay = type;
    }
    EXPORT_API void lua_pushRay(lua_State *l, float origin_x, float origin_y, float origin_z, float direction_x, float direction_y, float direction_z)
    {
        lua_checkstack(l, 3);
    ...
    EXPORT_API void lua_setRay(lua_State *l, int index, float origin_x, float origin_y, float origin_z, float direction_x, float direction_y, float direction_z)
    {
        lua_checkstack(l, 1);
    ...
    EXPORT_API void lua_getRay(lua_State *l, int index, float* origin_x, float* origin_y, float* origin_z, float* direction_x, float* direction_y, float* direction_z)
    {
        lua_checkstack(l, 1);
