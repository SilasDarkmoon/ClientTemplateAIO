...
namespace UnityEditorEx
{
    ...
    public class LuaLibExportWindow : EditorWindow
    {
        public static readonly Dictionary<string, string> LuaLibFileMap = new Dictionary<string, string>()
        {
            ...
            { "Packages/host.silas.mods.modsmain/Runtime/DistributeFlags.cs",                                  "Common/DistributeFlags.cs" },
            ...
            { "Packages/host.silas.mods.resmanager/Runtime/Libs/Framework/CommonStructs/ExtendedHash.cs",      "Common/ExtendedHash.cs" },
            ...
            { "Packages/host.silas.mods.lua/Runtime/Framework/LuaProfileEx.cs",                                "Lua/Framework/LuaProfileEx.cs" },
