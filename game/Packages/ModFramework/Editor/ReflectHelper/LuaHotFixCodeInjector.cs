...
namespace UnityEditorEx
{
    public static class LuaHotFixCodeInjector
    {
        ...
        public static void GenerateByRefUtils()
        {
            ...
            var root = ModEditor.GetPackageOrModRoot(ModEditorUtils.__MOD__);
            ...
            var type = asm.MainModule.GetType("ByRefUtils.Ref");
            TypeDefinition reftype = asm.MainModule.GetType("ByRefUtils.RawRef");
        ...
        internal static TypeDefinition GetLuaPack(int paramCnt)
        {
            ...
            {
                var luadll = GetOrLoadAssembly("ModLua");
                var typename = "ModLua.LuaPack";
                if (paramCnt > 0)
                {
                    typename += "`" + paramCnt;
                }
                ...
                if (existing == null)
                {
                    ...
                    var injecttype = new TypeDefinition("ModLua", "LuaPack`" + paramCnt, TypeAttributes.Public | TypeAttributes.SequentialLayout | TypeAttributes.AnsiClass | TypeAttributes.Sealed | TypeAttributes.BeforeFieldInit, valueType);
                    injecttype.Interfaces.Add(new InterfaceImplementation(luadll.MainModule.GetType("ModLua.ILuaPack")));
                    { // attributes
                    ...
                    var indexerListDefType = luadll.MainModule.GetType("ModLua.LuaPackIndexAccessorList`1");
                    ...
                    var accessorDefType = luadll.MainModule.GetType("ModLua.LuaPackIndexAccessor`1");
                    { // .cctor
                    ...
                    var luahubtype = luadll.MainModule.GetType("ModLua.LuaHub");
        ...
        internal static bool HasHotFixAttribute(this IMemberDefinition method)
        {
            ...
            {
                if (attr.AttributeType.FullName == "ModLua.LuaHotFixAttribute")
                {
        ...
        internal static void Inject(MethodDefinition method)
        {
            ...
            var excallClass = luadll.MainModule.GetType("ModLua.HotFixCaller");
